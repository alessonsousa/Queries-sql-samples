...
SELECT
	'ESTAGIO OBRIGATORIO EMPRESA'	AS TITULO,

	'INTRODUÇÃO' AS INTRO,

	'TITULO 1' AS TITULO1,
	'CLAUSULA 1' AS CLAUSULA1,

	'TITULO 2' AS TITULO2,
	'CLAUSULA 2' AS CLAUSULA2,

	'TITULO 3' AS TITULO3,
	'CLAUSULA 3' AS CLAUSULA3,

	'TITULO 4' AS TITULO4,
	'CLAUSULA 4' AS CLAUSULA4,

	'TITULO 5' AS TITULO5,
	'CLAUSULA 5' AS CLAUSULA5
FROM #CONSULTA1
